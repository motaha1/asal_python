...
k = list (zip(letters ,nums ))
print(k)


#### unzip ------ list of  tuple to 2 list 
...
#### convert zip to dictionary (convert 2 list to dictionary )
...
for key , val in nominated.items():
    for i in val:
        x.append(i)
